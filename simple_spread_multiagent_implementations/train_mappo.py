...
class Actor(nn.Module):
    ...
    def __init__(self, obs_dim=18, action_dim=5, hidden=64):
        ...
        self.net = nn.Sequential(
            ...
            nn.Linear(hidden, action_dim), nn.Sigmoid(),  # actions in [0, 1]
        )
...
def collect_rollout(env, actors, critic, n_steps=512, gamma=0.99, gae_lambda=0.95):
...
def train(total_timesteps=1_000_000, n_steps=512, lr=3e-4):
    ...
    actor_opts = {a: Adam(actors[a].parameters(), lr=lr) for a in agent_ids}
